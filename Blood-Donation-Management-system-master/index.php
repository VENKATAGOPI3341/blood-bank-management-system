...
<div class="col-12" style="height: 650px">
	...
	<img class="mySlides col-12" src="./blood1.jpg">
	<img class="mySlides col-12" src="./blood2.jpg">
	<img class="mySlides col-12" src="./blood3.avif">
</div>
	<div style="margin: 0; padding: 5%; text-align: center;">
		...
		<p>To make the best use of contemporary technologies in delivering a promising web portal to bring together all the blood donors in vizianagaram and visakapatnam; thereby fulfilling every blood request in our city.</p>
		</p>
	</div>
